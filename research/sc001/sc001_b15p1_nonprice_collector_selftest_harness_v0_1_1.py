...
RUNNER = ROOT / "research/sc001/sc001_b15p1_nonprice_transferability_collector_v0_1_1.py"
LIBRARY = ROOT / "research/sc001/sc001_b15p1_nonprice_transferability_lib_v0_1_1.py"
...
EXPECTED_TOKEN = "B15P1_NONPRICE_COLLECTOR_V011_SELF_TEST_PASS"
...
def main() -> int:
    ...
    try:
        ...
        write_json(
            COMPILE_MANIFEST,
            {
                "schema": "sc001.b15.p1_nonprice_collector_compile_guard.v0.1.1",
                "status": "B15P1_NONPRICE_COLLECTOR_V011_COMPILE_AND_SELFTEST_PASS",
        ...
        print("B15P1_NONPRICE_COLLECTOR_V011_COMPILE_AND_SELFTEST_PASS")
        return 0
        ...
        write_json(
            ...
            {
                "schema": "sc001.b15.p1_nonprice_collector_compile_guard.v0.1.1",
                "status": "B15P1_NONPRICE_COLLECTOR_V011_COMPILE_OR_SELFTEST_REVIEW",
                "compile_checks": compile_checks,
                "error": error,
                "exchange_calls_performed": False,
                "collector_launch_authorized": False,
        ...
        print("B15P1_NONPRICE_COLLECTOR_V011_COMPILE_OR_SELFTEST_REVIEW")
        print("error =", error)
        return 2
