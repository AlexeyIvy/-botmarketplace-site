...
SPEC = ROOT / "docs/research/sc001-b15-p1-final-launch-v0.1.1-wrapper-offline-preflight-spec-v0.1.json"
FREEZE = ROOT / "docs/research/sc001-b15-p1-final-launch-v0.1.1-wrapper-offline-preflight-freeze-v0.1.json"
...
'''
        ...
        manifest = {
            "schema": "sc001.b15.p1_final_launch_v011_wrapper_offline_preflight.v0.1",
            "status": PASS,
            "wrapper_sha256": sha256_file(WRAPPER),
            "spec_sha256": sha256_file(SPEC),
