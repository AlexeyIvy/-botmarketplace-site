...
from sc001_b15p1_nonprice_transferability_lib_v0_1_2 import (
...
STAGE = "SC001-B15P1-NONPRICE-TRANSFERABILITY-COLLECTOR-V0.1.2"
VERSION = "0.1.2"
SELFTEST_PASS = "B15P1_NONPRICE_COLLECTOR_V012_SELF_TEST_PASS"
SELFTEST_REVIEW = "B15P1_NONPRICE_COLLECTOR_V012_SELF_TEST_REVIEW"
...
IMPLEMENTATION_CONTRACT = ROOT / "docs/research/sc001-b15-p1-nonprice-collector-implementation-contract-v0.1.2.json"
...
SERVICE_FILE = ROOT / "ops/systemd/sc001-b15p1-transferability-v0.1.2.service"
FREEZE = ROOT / "docs/research/sc001-b15-p1-nonprice-collector-implementation-freeze-v0.1.2.json"
...
def require_freeze() -> dict[str, Any]:
    ...
    if fr.get("status") != "FROZEN_BEFORE_B15P1_NONPRICE_COLLECTOR_SELF_TEST_V012":
        fail("implementation freeze status mismatch")
    expected = {
        "runner_sha256": sha256_file(Path(__file__).resolve()),
        "library_sha256": sha256_file(
            Path(__file__).resolve().with_name(
                "sc001_b15p1_nonprice_transferability_lib_v0_1_2.py"
            )
        ),
...
def write_selftest_report(
    ...
    *,
    ...
    obj = {
        "schema": "sc001.b15.p1_nonprice_collector_implementation_self_test.v0.1.2",
        "status": status,
...
def self_test() -> int:
    ...
    try:
        ...
        from sc001_b15p1_nonprice_transferability_lib_v0_1_2 import validate_capability_snapshot
        validate_capability_snapshot(
            cap,
            runner_sha256=runner_sha,
