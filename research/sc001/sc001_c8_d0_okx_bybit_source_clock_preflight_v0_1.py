...
STAGE = "SC001-C8-D0-OKX-BYBIT-SOURCE-CLOCK-PREFLIGHT-V0.1"
PASS = "C8_D0_SOURCE_CLOCK_PREFLIGHT_PASS"
REVIEW = "C8_D0_SOURCE_CLOCK_PREFLIGHT_REVIEW"
...
PROTOCOL = ROOT / "docs/research/sc001-c8-d0-okx-bybit-source-clock-semantics-protocol-v0.1.md"
FREEZE = ROOT / "docs/research/sc001-c8-d0-implementation-freeze-v0.1.json"

DATA_ROOT = Path(
    os.environ.get("SC001_DATA_ROOT", str(Path.home() / "sc001_data"))
).expanduser().resolve()
OUT_DIR = DATA_ROOT / "SC001_C8_D0_SOURCE_CLOCK"
OUT = OUT_DIR / "sc001_c8_d0_source_clock_preflight_v0_1.json"
...
def require_freeze() -> dict:
    fr = load_json(FREEZE)
    if fr.get("status") != "FROZEN_BEFORE_C8_D0_RUN":
    ...
    for attempt in range(1, RETRIES + 1):
        try:
            req = urllib.request.Request(
                ...
                method="GET",
                headers={
                    "User-Agent": "BotMarketplace-SC001-C8-D0/0.1",
