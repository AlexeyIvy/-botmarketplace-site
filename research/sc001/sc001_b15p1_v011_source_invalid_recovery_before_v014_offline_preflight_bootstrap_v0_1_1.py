...
HARNESS = ROOT / "research/sc001/sc001_b15p1_v011_source_invalid_recovery_before_v014_offline_preflight_v0_1_1.py"
HARNESS_MANIFEST = OUT / "v011_source_invalid_recovery_before_v014_offline_preflight_v011_manifest.json"
BOOTSTRAP_MANIFEST = OUT / "v011_source_invalid_recovery_before_v014_offline_preflight_bootstrap_v011_manifest.json"

EXPECTED_HARNESS_SHA256 = "e115c2606f2ed25b0f17dbd6d33d4aa1f4c0aa6f608c0c29b793975529b42297"
EXPECTED_PASS = "B15P1_V011_SOURCE_INVALID_RECOVERY_WRAPPER_OFFLINE_PREFLIGHT_V011_PASS"
BOOTSTRAP_PASS = "B15P1_V011_SOURCE_INVALID_RECOVERY_BOOTSTRAP_V011_PASS"
BOOTSTRAP_REVIEW = "B15P1_V011_SOURCE_INVALID_RECOVERY_BOOTSTRAP_V011_REVIEW"
...
def main() -> int:
    ...
    try:
        ...
        write({
            "schema": "sc001.b15.p1_v011_source_invalid_recovery_bootstrap.v0.1.1",
            ...
            "next_state": "RECOVERY_V011_OFFLINE_PREFLIGHT_PASS",
        })
