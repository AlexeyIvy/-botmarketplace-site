...
FREEZE = ROOT / "docs/research/sc001-b15-p1-adapter-combined-offline-validation-freeze-v0.1.json"
SPEC = ROOT / "docs/research/sc001-b15-p1-adapter-combined-offline-validation-spec-v0.1.json"
...
CAP_HARNESS = ROOT / "research/sc001/sc001_b15p1_nonprice_source_capability_selftest_harness_v0_2.py"
CAP_PROBE = ROOT / "research/sc001/sc001_b15p1_nonprice_source_capability_revalidation_v0_2.py"
CAP_FREEZE = ROOT / "docs/research/sc001-b15-p1-nonprice-source-capability-revalidation-freeze-v0.2.json"
...
CAP_TOKEN = "B15P1_NONPRICE_SOURCE_CAPABILITY_REVALIDATION_V02_SELF_TEST_PASS"
CAP_HARNESS_TOKEN = "B15P1_NONPRICE_SOURCE_CAPABILITY_V02_COMPILE_AND_SELFTEST_PASS"
...
def require_freeze() -> dict[str, Any]:
    ...
    if fr.get("status") != "FROZEN_BEFORE_B15P1_ADAPTER_COMBINED_OFFLINE_VALIDATION_V01":
...
def verify_capability() -> dict[str, Any]:
    proc = run_child(CAP_HARNESS, "CAPABILITY_V02")
    if proc.returncode != 0:
...
def main() -> int:
    try:
        ...
        manifest = {
            "schema": "sc001.b15.p1_adapter_combined_offline_validation.v0.1",
            "status": PASS,
            ...
            "next_state": "PREPARE_B15P1_SOURCE_CAPABILITY_LIVE_RETRY_V02",
        }
