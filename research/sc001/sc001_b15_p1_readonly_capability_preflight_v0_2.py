...
STAGE="SC001-B15-P1-READONLY-CAPABILITY-PREFLIGHT-V0.2"
PASS="B15_P1_READONLY_CAPABILITY_PASS"
REVIEW="B15_P1_READONLY_CAPABILITY_REVIEW"

ROOT=Path(__file__).resolve().parents[2]
PROTOCOL=ROOT/"docs/research/sc001-b15-p1-readonly-capability-diagnostic-v0.2.md"
SECURITY=ROOT/"docs/research/sc001-b15-p1-read-only-credential-security-contract-v0.1.md"
FREEZE=ROOT/"docs/research/sc001-b15-p1-readonly-capability-implementation-freeze-v0.2.json"
...
def require_freeze()->dict:
    ...
    if fr.get("status")!="FROZEN_BEFORE_B15_P1_READONLY_CAPABILITY_DIAGNOSTIC_V02":
...
def http_json(url:str,headers:dict[str,str]|None=None)->dict:
    req=urllib.request.Request(url,headers=headers or {
        "User-Agent":"BotMarketplace-SC001-B15-P1/0.2",
