...
STAGE="SC001-B13C-BYBIT-PROSPECTIVE-LIQUIDATION-COLLECTOR-V0.1"
SELFTEST_PASS="B13C_COLLECTOR_SELF_TEST_PASS"
SELFTEST_REVIEW="B13C_COLLECTOR_SELF_TEST_REVIEW"
...
PROTOCOL=ROOT/"docs/research/sc001-b13c-bybit-prospective-liquidation-collector-protocol-v0.1.md"
REGISTRY=ROOT/"docs/research/sc001-contamination-registry-v0.26.json"
FREEZE=ROOT/"docs/research/sc001-b13c-bybit-prospective-liquidation-collector-implementation-freeze-v0.1.json"
...
def require_freeze()->dict:
    fr=load_json(FREEZE)
    if fr.get("status")!="FROZEN_BEFORE_B13C_PROSPECTIVE_COLLECTION":
    ...
    for attempt in range(1,RETRIES+1):
        try:
            req=urllib.request.Request(url,headers={
                "User-Agent":"BotMarketplace-SC001-B13C-Collector/0.1",
        ...
        while not STOP_REQUESTED:
            ...
            try:
                ...
                ws=websocket.create_connection(
                    WS_URL,
                    timeout=TIMEOUT,
                    header=["User-Agent: BotMarketplace-SC001-B13C-Collector/0.1"],
                )
                ws.settimeout(1.0)
