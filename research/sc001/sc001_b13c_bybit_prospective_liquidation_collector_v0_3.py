...
SELFTEST_PASS="B13C_COLLECTOR_V03_SELF_TEST_PASS"
SELFTEST_REVIEW="B13C_COLLECTOR_V03_SELF_TEST_REVIEW"
...
PROTOCOL=ROOT/"docs/research/sc001-b13c-prospective-liquidation-collector-operational-resilience-v0.2.md"
REGISTRY=ROOT/"docs/research/sc001-contamination-registry-v0.26.json"
FREEZE=ROOT/"docs/research/sc001-b13c-bybit-prospective-liquidation-collector-implementation-freeze-v0.3.json"
...
def require_freeze()->dict:
    fr=load_json(FREEZE)
    if fr.get("status")!="FROZEN_BEFORE_B13C_PROSPECTIVE_COLLECTION_V03":
    ...
    for attempt in range(1,RETRIES+1):
        try:
            req=urllib.request.Request(url,headers={
                "User-Agent":"BotMarketplace-SC001-B13C-Collector/0.3",
        ...
        while not STOP_REQUESTED:
            ...
            try:
                ...
                ws=websocket.create_connection(
                    WS_URL,
                    timeout=TIMEOUT,
                    header=["User-Agent: BotMarketplace-SC001-B13C-Collector/0.3"],
                )
                ws.settimeout(1.0)
                state["connection_status"]="CONNECTED"
                state["last_connect_ms"]=now_ms()
                state["last_disconnect_ms"]=None
