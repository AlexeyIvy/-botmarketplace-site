...
STAGE = "SC001-B13A-FUNDING-DIFFERENTIAL-STRUCTURAL-PREFLIGHT-V0.2"
...
FREEZE = ROOT / "docs/research/sc001-b13a-funding-differential-implementation-freeze-v0.2.json"

DATA_ROOT = Path(os.environ.get("SC001_DATA_ROOT", str(Path.home()/"sc001_data"))).expanduser().resolve()
OUT_DIR = DATA_ROOT / "SC001_B13A_FUNDING_PREFLIGHT"
OKX_ARCH = OUT_DIR / "okx_archives"
OUT = OUT_DIR / "sc001_b13a_funding_differential_structural_preflight_v0_2.json"
    ...
    for attempt in range(1, RETRIES+1):
        try:
            req = urllib.request.Request(url, headers={
                "User-Agent":"BotMarketplace-SC001-B13A/0.2",
