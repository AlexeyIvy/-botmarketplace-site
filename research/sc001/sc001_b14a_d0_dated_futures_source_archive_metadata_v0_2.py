...
STAGE="SC001-B14A-D0-DATED-FUTURES-SOURCE-ARCHIVE-METADATA-V0.2"
PASS="B14A_D0_V02_SOURCE_ARCHIVE_METADATA_PASS"
REVIEW="B14A_D0_V02_SOURCE_ARCHIVE_METADATA_REVIEW"
SELFTEST_PASS="B14A_D0_V02_SELF_TEST_PASS"
SELFTEST_REVIEW="B14A_D0_V02_SELF_TEST_REVIEW"
...
FREEZE=ROOT/"docs/research/sc001-b14a-d0-implementation-freeze-v0.2.json"

DATA_ROOT=Path(os.environ.get("SC001_DATA_ROOT",str(Path.home()/"sc001_data"))).expanduser().resolve()
OUT_DIR=DATA_ROOT/"SC001_B14A_D0_SOURCE_ARCHIVE"
OUT=OUT_DIR/"sc001_b14a_d0_source_archive_metadata_v0_2.json"
...
def require_freeze()->dict:
    fr=load_json(FREEZE)
    if fr.get("status")!="FROZEN_BEFORE_B14A_D0_V02_RUN":
    ...
    for attempt in range(1,RETRIES+1):
        try:
            req=urllib.request.Request(url,headers={
                "User-Agent":"BotMarketplace-SC001-B14A-D0/0.2",
