...
STAGE = "SC001-B15P1-NONPRICE-SOURCE-CAPABILITY-REVALIDATION-V0.2.1"
PASS = "B15P1_NONPRICE_SOURCE_CAPABILITY_REVALIDATION_PASS"
REVIEW = "B15P1_NONPRICE_SOURCE_CAPABILITY_REVALIDATION_REVIEW"
SELFTEST_PASS = "B15P1_NONPRICE_SOURCE_CAPABILITY_REVALIDATION_V021_SELF_TEST_PASS"
SELFTEST_REVIEW = "B15P1_NONPRICE_SOURCE_CAPABILITY_REVALIDATION_V021_SELF_TEST_REVIEW"
...
SPEC = ROOT / "docs/research/sc001-b15-p1-nonprice-source-capability-revalidation-spec-v0.2.1.json"
FREEZE = ROOT / "docs/research/sc001-b15-p1-nonprice-source-capability-revalidation-freeze-v0.2.1.json"
...
def require_freeze() -> dict[str, Any]:
    ...
    if fr.get("status") != "FROZEN_BEFORE_B15P1_NONPRICE_SOURCE_CAPABILITY_REVALIDATION_V021":
...
def build_snapshot_fixture(
    ...
    return {
        "schema": "sc001.b15.p1_nonprice_source_capability_snapshot.v0.2.1",
        "status": PASS,
...
def write_selftest_manifest(status: str, error: str | None = None) -> None:
    ...
    atomic_json(
        ...
        {
            "schema": "sc001.b15.p1_nonprice_source_capability_revalidation_self_test.v0.2.1",
            "status": status,
            "error": error,
...
def live_run() -> int:
    try:
        ...
        safe_summary = {
            "schema": "sc001.b15.p1_nonprice_source_capability_safe_summary.v0.2.1",
            "status": PASS,
