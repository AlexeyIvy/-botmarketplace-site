...
MANIFEST = OUT / "v011_source_invalid_recovery_before_v014_offline_preflight_v011_manifest.json"

WRAPPER = ROOT / "scripts/research/run-b15p1-v011-source-invalid-recovery-before-v014-v0.1.1.sh"
SPEC = ROOT / "docs/research/sc001-b15-p1-v011-source-invalid-recovery-before-v014-preflight-spec-v0.1.1.json"
PASS = "B15P1_V011_SOURCE_INVALID_RECOVERY_WRAPPER_OFFLINE_PREFLIGHT_V011_PASS"
REVIEW = "B15P1_V011_SOURCE_INVALID_RECOVERY_WRAPPER_OFFLINE_PREFLIGHT_V011_REVIEW"
...
def run_snapshot_validator(block: str, generated_utc: str, *, corrupt_safe_sha: bool = False) -> subprocess.CompletedProcess[str]:
...
def main() -> int:
    ...
    try:
        ...
        if "EXPECTED_SNAPSHOT_SHA=" in text:
            raise RuntimeError("hardcoded snapshot SHA remains in v0.1.1 recovery")
        for stale in (
        ...
        write({
            "schema": "sc001.b15.p1_v011_source_invalid_recovery_before_v014_offline_preflight.v0.1.1",
            "status": PASS,
            ...
            "next_state": "RUN_V011_SOURCE_INVALID_RECOVERY_V011_ON_VPS",
        })
        print(PASS)
        print("dynamic_snapshot_semantic_fixtures = PASS")
