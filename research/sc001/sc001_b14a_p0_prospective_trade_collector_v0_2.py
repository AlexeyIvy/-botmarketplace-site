...
STAGE="SC001-B14A-P0-PROSPECTIVE-TRADE-COLLECTOR-V0.2"
SELFTEST_PASS="B14A_P0_COLLECTOR_V02_SELF_TEST_PASS"
SELFTEST_REVIEW="B14A_P0_COLLECTOR_V02_SELF_TEST_REVIEW"
...
FREEZE=ROOT/"docs/research/sc001-b14a-p0-collector-implementation-freeze-v0.2.json"
...
def require_freeze():
    fr=load_json(FREEZE)
    if fr.get("status")!="FROZEN_BEFORE_B14A_P0_COLLECTION_V02":
...
def request_json(url):
    req=urllib.request.Request(url,headers={
        "User-Agent":"BotMarketplace-SC001-B14A-P0/0.2",
    ...
    while not STOP and now_ms()<=CAPTURE_END_MS+5000:
        ...
        try:
            ...
            ws=websocket.create_connection(
                ...
                header=["User-Agent: BotMarketplace-SC001-B14A-P0/0.2"],
            )
            ws.settimeout(1.0)
