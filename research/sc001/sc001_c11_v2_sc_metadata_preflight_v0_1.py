...
STAGE = "SC001-C11-V2-SC-METADATA-PREFLIGHT-V0.1"
PASS = "C11_V2_SC_METADATA_PREFLIGHT_PASS"
REVIEW = "C11_V2_SC_METADATA_PREFLIGHT_REVIEW"

EVENTS = (
    ("EMPLOYMENT","2025-07-03","2025-07-03T12:30:00Z","https://www.bls.gov/schedule/2025/07_sched_list.htm","Employment Situation","July 3, 2025"),
    ("CPI","2025-07-15","2025-07-15T12:30:00Z","https://www.bls.gov/schedule/2025/07_sched_list.htm","Consumer Price Index","July 15, 2025"),
    ("EMPLOYMENT","2025-08-01","2025-08-01T12:30:00Z","https://www.bls.gov/schedule/2025/08_sched_list.htm","Employment Situation","August 1, 2025"),
    ("CPI","2025-08-12","2025-08-12T12:30:00Z","https://www.bls.gov/schedule/2025/08_sched_list.htm","Consumer Price Index","August 12, 2025"),
    ("EMPLOYMENT","2025-09-05","2025-09-05T12:30:00Z","https://www.bls.gov/schedule/2025/09_sched_list.htm","Employment Situation","September 5, 2025"),
    ("CPI","2025-09-11","2025-09-11T12:30:00Z","https://www.bls.gov/schedule/2025/09_sched_list.htm","Consumer Price Index","September 11, 2025"),
    ("EMPLOYMENT","2026-01-09","2026-01-09T13:30:00Z","https://www.bls.gov/schedule/2026/01_sched_list.htm","Employment Situation","January 9, 2026"),
    ("CPI","2026-01-13","2026-01-13T13:30:00Z","https://www.bls.gov/schedule/2026/01_sched_list.htm","Consumer Price Index","January 13, 2026"),
    ("EMPLOYMENT","2026-02-11","2026-02-11T13:30:00Z","https://www.bls.gov/schedule/2026/02_sched_list.htm","Employment Situation","February 11, 2026"),
    ("CPI","2026-02-13","2026-02-13T13:30:00Z","https://www.bls.gov/schedule/2026/02_sched_list.htm","Consumer Price Index","February 13, 2026"),
    ("EMPLOYMENT","2026-03-06","2026-03-06T13:30:00Z","https://www.bls.gov/schedule/2026/03_sched_list.htm","Employment Situation","March 6, 2026"),
    ("CPI","2026-03-11","2026-03-11T12:30:00Z","https://www.bls.gov/schedule/2026/03_sched_list.htm","Consumer Price Index","March 11, 2026"),
    ("EMPLOYMENT","2026-04-03","2026-04-03T12:30:00Z","https://www.bls.gov/schedule/2026/04_sched_list.htm","Employment Situation","April 3, 2026"),
    ("CPI","2026-04-10","2026-04-10T12:30:00Z","https://www.bls.gov/schedule/2026/04_sched_list.htm","Consumer Price Index","April 10, 2026"),
    ("EMPLOYMENT","2026-05-08","2026-05-08T12:30:00Z","https://www.bls.gov/schedule/2026/05_sched_list.htm","Employment Situation","May 8, 2026"),
    ("CPI","2026-05-12","2026-05-12T12:30:00Z","https://www.bls.gov/schedule/2026/05_sched_list.htm","Consumer Price Index","May 12, 2026"),
    ("EMPLOYMENT","2026-06-05","2026-06-05T12:30:00Z","https://www.bls.gov/schedule/2026/06_sched_list.htm","Employment Situation","June 5, 2026"),
    ("CPI","2026-06-10","2026-06-10T12:30:00Z","https://www.bls.gov/schedule/2026/06_sched_list.htm","Consumer Price Index","June 10, 2026"),
    ("EMPLOYMENT","2026-07-02","2026-07-02T12:30:00Z","https://www.bls.gov/schedule/2026/07_sched_list.htm","Employment Situation","July 2, 2026"),
    ("CPI","2026-07-14","2026-07-14T12:30:00Z","https://www.bls.gov/schedule/2026/07_sched_list.htm","Consumer Price Index","July 14, 2026"),
    ("EMPLOYMENT","2026-08-07","2026-08-07T12:30:00Z","https://www.bls.gov/schedule/2026/08_sched_list.htm","Employment Situation","August 7, 2026"),
    ("CPI","2026-08-12","2026-08-12T12:30:00Z","https://www.bls.gov/schedule/2026/08_sched_list.htm","Consumer Price Index","August 12, 2026"),
    ("EMPLOYMENT","2026-09-04","2026-09-04T12:30:00Z","https://www.bls.gov/schedule/2026/09_sched_list.htm","Employment Situation","September 4, 2026"),
    ("CPI","2026-09-11","2026-09-11T12:30:00Z","https://www.bls.gov/schedule/2026/09_sched_list.htm","Consumer Price Index","September 11, 2026"),
)
...
PROTOCOL = ROOT / "docs/research/sc001-c11-v2-selection-metadata-preflight-protocol-v0.1.md"
FREEZE = ROOT / "docs/research/sc001-c11-v2-selection-metadata-preflight-implementation-freeze-v0.1.json"
...
OUT = OUT_DIR / "sc001_c11_v2_sc_metadata_preflight_report_v0_1.json"
...
def require_freeze() -> None:
    fr = load_json(FREEZE)
    if fr.get("status") != "FROZEN_BEFORE_C11_V2_SC_METADATA_RUN":
...
def verify_bls(kind: str, date: str, url: str, title: str, date_text: str) -> dict:
    req = urllib.request.Request(
        url,
        headers={
            "User-Agent": "BotMarketplace-SC001-C11-V2-Metadata/0.1",
            "Accept": "text/html,*/*",
        },
    )
    ...
    checks = {
        "date": date_text.lower() in text,
        "title": title.lower() in text,
        "time": "08:30 am" in text,
    }
    if not all(checks.values()):
        fail(f"BLS metadata mismatch {kind} {date}: {checks}")
    return {
        "pass": True,
        "url": url,
        "final_url": final,
        ...
        try:
            ...
            for node in walk(obj.get("data")):
                if isinstance(node, dict):
                    ...
                    url = node.get("url")
                    if fn == basename and isinstance(url, str) and trusted(url, basename) and url not in found:
                        found.append(url)
            if len(found) == 1:
...
def main() -> int:
    try:
        ...
        for i, (kind, date, utc, url, title, date_text) in enumerate(EVENTS, 1):
            print(f"C11-V2-SC-META [{i}/24] {kind} {date}", flush=True)
