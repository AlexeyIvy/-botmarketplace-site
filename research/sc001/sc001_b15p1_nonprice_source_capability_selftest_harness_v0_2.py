...
PROBE = ROOT / "research/sc001/sc001_b15p1_nonprice_source_capability_revalidation_v0_2.py"
...
EXPECTED = "B15P1_NONPRICE_SOURCE_CAPABILITY_REVALIDATION_V02_SELF_TEST_PASS"
...
def main() -> int:
    ...
    try:
        ...
        write_json(
            COMPILE_MANIFEST,
            {
                "schema": "sc001.b15.p1_nonprice_source_capability_compile_guard.v0.2",
                "status": "B15P1_NONPRICE_SOURCE_CAPABILITY_V02_COMPILE_AND_SELFTEST_PASS",
                "checks": checks,
        ...
        print("B15P1_NONPRICE_SOURCE_CAPABILITY_V02_COMPILE_AND_SELFTEST_PASS")
        return 0
        ...
        write_json(
            ...
            {
                "schema": "sc001.b15.p1_nonprice_source_capability_compile_guard.v0.2",
                "status": "B15P1_NONPRICE_SOURCE_CAPABILITY_V02_COMPILE_OR_SELFTEST_REVIEW",
                "checks": checks,
                "error": err,
                "exchange_calls_performed": False,
                "credentials_required": False,
        ...
        print("B15P1_NONPRICE_SOURCE_CAPABILITY_V02_COMPILE_OR_SELFTEST_REVIEW")
        print("error =", err)
        return 2
