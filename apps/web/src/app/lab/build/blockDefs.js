...
export const BLOCK_DEF_MAP = Object.fromEntries(BLOCK_DEFS.map((b) => [b.type, b]));
// Type compatibility: which output types can connect to which input types.
// Per §9.1: strict — no implicit coercions.
export function isPortTypeCompatible(outputType, inputType) {
