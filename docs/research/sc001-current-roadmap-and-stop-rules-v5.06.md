# SC001 Current Roadmap and Stop Rules v5.06

Date: 2026-09-19
Status: **CURRENT SC001 ROADMAP — B14-A V0.4 SELF-TEST PASS / OFFICIAL METADATA D0 RUN NEXT**
Supersedes: `sc001-current-roadmap-and-stop-rules-v5.05.md`
...
`research/sc001/sc001_b14a_d0_dated_futures_source_archive_metadata_v0_4.py --mode run`
...
Run metadata-only B14-A D0 v0.4 once.
