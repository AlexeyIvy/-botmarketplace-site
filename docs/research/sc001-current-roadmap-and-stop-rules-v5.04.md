# SC001 Current Roadmap and Stop Rules v5.04

Date: 2026-09-19
Status: **CURRENT SC001 ROADMAP — B14-A V0.3 SELF-TEST PASS / METADATA-ONLY D0 RUN NEXT**
Supersedes: `sc001-current-roadmap-and-stop-rules-v5.03.md`
...
`research/sc001/sc001_b14a_d0_dated_futures_source_archive_metadata_v0_3.py --mode run`

Possible source states:

- `B14A_D0_V03_SOURCE_ARCHIVE_METADATA_PASS`;
...
- FUTURES trade-body download/open;
...
Run metadata-only B14-A D0 v0.3 once.
