...
sudo systemctl start sc001-b13c-liquidation.service
sudo systemctl start sc001-b14a-p0.service

sleep 5

B13="$(systemctl is-active sc001-b13c-liquidation.service || true)"
B14="$(systemctl is-active sc001-b14a-p0.service || true)"
START_MS="$(date +%s%3N)"
...
systemctl --no-pager --full status sc001-b13c-liquidation.service | sed -n '1,12p'
echo
systemctl --no-pager --full status sc001-b14a-p0.service | sed -n '1,12p'
