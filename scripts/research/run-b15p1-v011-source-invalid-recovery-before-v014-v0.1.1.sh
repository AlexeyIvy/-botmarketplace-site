...
assert "B15P1_NONPRICE_SOURCE_CAPABILITY_REVALIDATION_COMMAND_V022_PASS" in cap_log
assert "security_firewall = PASS" in cap_log
assert "collector_launch_authorized=False" in cap_log
assert "price_data_used=False" in cap_log
assert "pnl_data_used=False" in cap_log
assert "live_execution_authorized=False" in cap_log
