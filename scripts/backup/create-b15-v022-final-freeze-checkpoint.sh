...
# BotMarketplace SC001/B15-P1 identity-route v0.2.2 final-freeze checkpoint.
...
FREEZE_COMMIT="7fdaf8c8e3053e2bbf266ec7d89c3abc90c3661f"
...
NAME="botmarketplace-sc001-b15-v022-final-checkpoint-${RUN_ID}"
